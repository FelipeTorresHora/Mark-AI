---
name: frontend-wise
description: O Design System inspirado na Wise reflete uma plataforma financeira ousada, otimista e confiante, traduzindo visualmente o conceito de "dinheiro sem fronteiras". Afastando-se do azul corporativo tradicional e monótono dos bancos, o sistema adota uma estética vibrante inspirada na natureza. A interface opera sobre uma base clara e quente, com forte contraste gerado por textos quase pretos e pontos de atenção em um verde-limão inconfundível.
---
