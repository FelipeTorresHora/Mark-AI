...
function XComposer() {
    ...
    const scheduleIsPast = hasSchedule && isDatetimeLocalBeforeNow(scheduledAt, scheduleNowMs);
    ...
    async function submitSchedule() {
        if (disabled || !hasSchedule || new Date(scheduledAt).getTime() <= Date.now()) return;
